export const tasks = {
  ...
  forms: {
    ...
    allowedInputs: true,
    maxConnection: 1,
    refDataKeys: ['selector', 'variableName', 'optionPosition', 'delay'],
    autocomplete: ['variableName'],
    data: {
      disableBlock: false,
      description: '',
  ...
  'tax-vat-load': {
    name: '增值税申报表解析',
    description: '从全局数据、变量或本地路径解析增值税 Excel',
    icon: 'riFileChartLine',
    component: 'BlockBasic',
    editComponent: 'EditTaxVatLoad',
    category: 'data',
    inputs: 1,
    outputs: 1,
    allowedInputs: true,
    maxConnection: 1,
    refDataKeys: ['description', 'filePath', 'variableKey', 'globalDataKey'],
    data: {
      disableBlock: false,
      description: '',
      source: 'globalData',
      globalDataKey: 'vatExcelBase64',
      variableKey: '',
      filePath: '',
      outputVariable: 'vatModel',
    },
  },
  'tax-vat-validate': {
    name: '增值税数据校验',
    description: '结构/业务/跨表校验',
    icon: 'riShieldCheckLine',
    component: 'BlockBasic',
    editComponent: 'EditTaxVatValidate',
    category: 'data',
    inputs: 1,
    outputs: 1,
    allowedInputs: true,
    maxConnection: 1,
    refDataKeys: ['description', 'modelVariable', 'reportVariable'],
    data: {
      disableBlock: false,
      description: '',
      modelVariable: 'vatModel',
      reportVariable: 'vatValidationReport',
      gateMode: 'soft',
      allowOverride: true,
    },
  },
  'tax-vat-fill': {
    name: '增值税自动填报',
    description: '在上海电子税务局页面填报',
    icon: 'riEditBoxLine',
    component: 'BlockBasic',
    editComponent: 'EditTaxVatFill',
    category: 'interaction',
    inputs: 1,
    outputs: 1,
    allowedInputs: true,
